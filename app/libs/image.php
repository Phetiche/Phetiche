 ...
 * Formerly known as: The Phetiche image processor
 * It was part of the core, but there is no need to keep this as part
 * of the core since anyone may use his/her own image processing toolkit.
 *
...
class image {
	...
	{
		if ($name && $filename) {
			$output_name = cypher::randomCode(microtime(true));
	...
	public function url($url = '', $temp_path = '')
	{
		if ($url) {
			...
			$temp_name = cypher::randomCode(microtime(true));
